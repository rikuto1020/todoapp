...
ActiveRecord::Schema.define(version: 2020_09_28_103217) do
  ...
  create_table "category_messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "message_id"
    t.bigint "category_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id"], name: "index_category_messages_on_category_id"
    t.index ["message_id"], name: "index_category_messages_on_message_id"
  end
  ...
  add_foreign_key "category_messages", "categories"
  add_foreign_key "category_messages", "messages"
